 ...
 * Plugin format 2.0
 */
#App\Plugins\Payment\Nganluong\AppConfig.php
namespace App\Plugins\Payment\Nganluong;

use App\Plugins\Payment\Nganluong\Models\PluginModel;
...
class AppConfig extends ConfigDefault
{
    ...
    public function __construct()
    {
      ...
      //  $this->URL_API = 'https://sandbox.nganluong.vn:8088/nl35/checkout.api.nganluong.post.php';
        ...
        $this->NL_RECEIVER = sc_config('NL_RECEIVER');
        $this->MERCHANT_ID = sc_config('MERCHANT_ID');
        $this->MERCHANT_PASS = sc_config('MERCHANT_PASS');

    }

    public function getRECEIVER() {
        return $this->NL_RECEIVER;
    }
        ...
        if ($check) {
            ...
            $dataInsert = [
                ...
                [
                    ...
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.NL_RECEIVER',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.MERCHANT_ID',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.MERCHANT_PASS',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => 'sandbox',
                    'detail' => $this->pathPlugin.'::lang.NganLuong_env',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'nganluong_order_status_faild',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::ORDER_STATUS_FAILD,
                    'detail' => $this->pathPlugin.'::lang.nganluong_order_status_faild',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'nganluong_order_status_success',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::ORDER_STATUS_PROCESSING,
                    'detail' => $this->pathPlugin.'::lang.nganluong_order_status_success',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'nganluong_payment_status',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::PAYMENT_STATUS,
                    'detail' => $this->pathPlugin.'::lang.nganluong_payment_status',
                ],
            ];
