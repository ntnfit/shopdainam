 ...
 * Plugin format 2.0
 */
#App\Plugins\Payment\AuthorizeNet\AppConfig.php
namespace App\Plugins\Payment\AuthorizeNet;

use App\Plugins\Payment\AuthorizeNet\Models\PluginModel;
use SCart\Core\Admin\Models\AdminConfig;
use App\Plugins\ConfigDefault;
use SCart\Core\Front\Models\ShopOrderStatus;
use SCart\Core\Front\Models\ShopPaymentStatus;
use App\Plugins\Payment\AuthorizeNet\ProcessPayment;
...
class AppConfig extends ConfigDefault
{
    ...
    public function __construct()
    {
        ...
        $this->APIKey = sc_config('ANET_API_LOGIN_ID');
        $this->ClientKey = sc_config('ClientKey');
        $this->TransactionKey = sc_config('ANET_TRANSACTION_KEY');
        if(sc_config('authorize_env') == 'production'){
            $this->urlAPI = 'https://js.authorize.net/v2/Accept.js';
        }
         else {
            $this->urlAPI = 'https://jstest.authorize.net/v2/Accept.js';
        }
        ...
        if ($check) {
            ...
            $dataInsert = [
                ...
                [
                    ...
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.ANET_API_LOGIN_ID',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.ClientKey',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => '',
                    'detail' => $this->pathPlugin.'::lang.ANET_TRANSACTION_KEY',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    ...
                    'sort' => 0, // Sort extensions in group
                    'value' => 'sandbox',
                    'detail' => $this->pathPlugin.'::lang.authorize_env',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'authorize_order_status_faild',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::ORDER_STATUS_FAILD,
                    'detail' => $this->pathPlugin.'::lang.authorize_order_status_faild',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'authorize_order_status_success',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::ORDER_STATUS_PROCESSING,
                    'detail' => $this->pathPlugin.'::lang.authorize_order_status_success',
                ],
                [
                    'group' => '',
                    'code' => $this->configKey.'_config',
                    'key' => 'authorize_payment_status',
                    'sort' => 0, // Sort extensions in group
                    'value' => self::PAYMENT_STATUS,
                    'detail' => $this->pathPlugin.'::lang.authorize_payment_status',
                ],
