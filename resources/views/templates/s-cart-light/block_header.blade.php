              ...
              <div class="row">
                <div class="col-lg-7">
                  <div class="float-left">
                    <p>{{ sc_language_render('store.hotline') }}: {{ sc_store('long_phone', ($storeId ?? null)) }}</p>
                    <p><a href="mailto:#{{ sc_store('email', ($storeId ?? null)) }}">{{ sc_language_render('store.email') }}: {{ sc_store('email', ($storeId ?? null)) }}</a></p>
                  </div>
                </div>
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item rd-navbar--has-dropdown rd-navbar-submenu">
                      <a class="rd-nav-link" href="#">{{sc_language_render('front.categories')}}</a>
                      <span class="rd-navbar-submenu-toggle"></span>
                      <ul class="rd-menu rd-navbar-dropdown" id="item-category">
                        @foreach( $catagory as $key => $value)
                            <li class="rd-dropdown-item">
                            <a class="rd-dropdown-link" href="{{$value->getUrl()}}">
                                {{$value->title}}
                            </a>
                             </li>
                        @endforeach
