                        ...
                        <tbody>
                            ...
                            @foreach($cart as $item)
                                ...
                                <tr class="row_cart">
                                    ...
                                    <td>{{$item->qty}}</td>
                                    <td>{{$product->weight*$item->qty}} Lbs</td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            ...
                            <table class="table box table-bordered" id="showTotal">
                                <tr> <th>{{sc_language_render('order.infosent')}} </th></tr>
                                <tr>
                                    <th>{{ sc_language_render('order.fullname') }}:</td>
                                    <td>{{ $shippingAddress['fullname'] }}</td>
                                </tr>

                                <tr>
                                    <th>{{ sc_language_render('order.email') }}:</td>
                                    <td>{{ $shippingAddress['emailsent'] }}</td>
                                </tr>
                                <tr>
                                    <th>{{ sc_language_render('order.phone') }}:</td>
                                    <td>{{ $shippingAddress['phonesent'] }}</td>
                                </tr>
                                <tr>
                                    <th>{{ sc_language_render('order.address') }}:</td>
                                    <td>{{ $shippingAddress['addresssent'] }}</td>
                                </tr>
                                <tr> <th>{{sc_language_render('order.inforecevie')}} </th></tr>
                                <tr>
