...
<title>Cổng thanh toán ngân lượng </title>
<style>
...
if(@$_POST['nlpayment']) {
	...
	$total_amount=$OrderAmount;
	 ...
	 $array_items[0]= array('item_name1' => 'Product name',
					 ...
					 'item_url1' => 'https://bachhoamy.com/');
					 
	// $array_items=array();		
	if(empty($_POST['option_payment']))	
	{
		$data='';
	}
	else
	{
		$data=$_POST['option_payment'];
	}	 
	 $payment_method =$data;
	 ...
	 $tax_amount=0;
	 $fee_shipping=0;
	 $return_url =route('process_nl');
	 $cancel_url =route('cancel_nganluong').'?id='.$order_code ;
	
	 $buyer_fullname =$Ofullname;
	 $buyer_email =$Oemail;
	 $buyer_mobile =$Ophone;
	...
	if($payment_method !='' && $buyer_email !="" && $buyer_mobile !="" && $buyer_fullname !="" && filter_var( $buyer_email, FILTER_VALIDATE_EMAIL )  ){
		...
		echo "<h3> Bạn chưa chọn phương thức thanh toán </h3>";
	}
 }				
...
<body>	
	...
	@csrf
		<table style="clear:both;width:500px;padding-left:46px;"> 
			<tr><td colspan="2"><p><span style="color:#ff5a00;font-weight:bold;text-decoration:underline;">Lưu ý</span> Thông tin thanh toán </td>
				
			</tr>
			<tr><td>Số tiền thanh toán: </td>
				<td>
					 <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="{{sc_currency_format($OrderAmount).sc_currency_code()}}" disabled>
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="{{$Ofullname}}" disabled>
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="{{$Oemail}}" disabled>
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="{{$Ophone}}" disabled>
				</td>
			</tr>				
		</table>	
