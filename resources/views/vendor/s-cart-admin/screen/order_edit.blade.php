          ...
          <div class="row" id="order-body">
            <div class="col-sm-6">
 	 	    ...
 	 	    <tr>
                    ...
                    <tr>
                      <td class="td-title">{{ sc_language_render('order.full_name') }}:</td><td>{!! empty($order->sent_fullname)?'N/A':$order->sent_fullname!!}</td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ sc_language_render('order.phone') }}:</td><td>{!! empty($order->sent_phone)?'N/A':$order->sent_phone!!}</td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ sc_language_render('order.email') }}:</td><td>{!! empty($order->sent_email)?'N/A':$order->sent_email!!}</td>
                    </tr>
                    <tr>
                      <td class="td-title">{{ sc_language_render('order.address') }}:</td><td>{!! empty($order->sent_addrress)?'N/A':$order->sent_addrress!!}</td>
                    </tr>
                ...
                <tbody>
                    @foreach ($order->details as $item)
                          <tr>
                            ...
                            <td>{{ $item->sku }}</td>
                            <td class="product_price"><a href="#" class="edit-item-detail" data-value="{{ $item->price }}" data-name="price" data-type="number" min=0 data-pk="{{ $item->id }}" data-url="{{ route("admin_order.edit_item") }}" data-title="{{ sc_language_render('product.price') }}">{{ $item->price }}</a></td>
                            ...
                            <td class="product_tax"><a href="#" class="edit-item-detail" data-value="{{ $item->tax }}" data-name="tax" data-type="number" min=0 data-pk="{{ $item->id }}" data-url="{{ route("admin_order.edit_item") }}" data-title="{{ sc_language_render('order.tax') }}"> {{ $item->tax }}</a></td>
                            <td>
