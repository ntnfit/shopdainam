                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        <div class="row mb-2 mb-sm-0 py-25">
                          ...
                          <div class="d-none d-sm-block col-2 text-95 text-right">{{ $detail['price'] }}</div>
                          <div class="col-2 text-secondary-d2 text-right">{{$detail['total_price'] }}</div>
                        </div>
                        @endforeach
                    </div>
                    <hr>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <div class="row my-2">
                                <div class="col-7 text-right">
                                    {{ sc_language_render('order.totals.subcost') }}
                                </div>
                                <div class="col-5 text-right">
                                    <span class="text-120 text-secondary-d1">{{ sc_currency_render_symbol($subcost, $currency) }}</span>
                                </div>
                            </div>
