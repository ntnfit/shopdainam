...
Route::group(
	...
	$prefixCustomerReferral     = sc_config('PREFIX_MEMBER_REFERRAL')??'referral';
	...
	$router->get('/'.$prefixCustomerReferral.$suffix, $nameSpaceFrontCustomer.'\ShopAccountController@getReferral')
